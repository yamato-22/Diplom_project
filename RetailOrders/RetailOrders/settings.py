"""
Django settings for RetailOrders project.
...
ROOT_URLCONF = 'RetailOrders.urls'
...
WSGI_APPLICATION = 'RetailOrders.wsgi.application'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),     # Время жизни access-токена (60минут)
